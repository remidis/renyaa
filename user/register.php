...
<body>
  ...
  <main>
    <center>
      ...
      <div class="container">
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 144px 0px 144px; border: 1px solid #EEE;">

          <h4 class="amber-text accent-4">Registration</h4>
          <div class="section"></div>
          ...
          <form action="./auth.php" class="col s12" method="post">
            ...
            <div class='row'>
              ...
              <div class='input-field col s6'>
                <input class='validate' type='email' name='cfm-email' id='cfm-email' required/>
                <label for='cfm-email'>Confirm Email</label>
              </div>
            </div>
            ...
            <div class='row'>
              ...
              <div class='input-field col s6'>
                <input class='validate' type='password' name='cfm-password' id='cfm-password' required/>
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <input class="filled-in" type="checkbox" id="agree-tc" name="tc_agree">
                <label for="agree-tc">I agree to the Terms and Conditions.</label>
              </div>
            ...
            <center>
              <div class='row'>
                <button type='submit' name='btn_login' class='col s12 btn btn-large waves-effect amber accent-4'>Create Account</button>
              </div>
            </center>
          </form>
        </div>
